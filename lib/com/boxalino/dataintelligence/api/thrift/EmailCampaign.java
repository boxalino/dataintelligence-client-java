            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.baseUrl = new HashMap<Language,String>(2*_map0.size);
                Language _key1;
                String _val2;
                for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                {
                  _key1 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
                  _val2 = iprot.readString();
                  struct.baseUrl.put(_key1, _val2);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.subject = new HashMap<Language,String>(2*_map4.size);
                Language _key5;
                String _val6;
                for (int _i7 = 0; _i7 < _map4.size; ++_i7)
                {
                  _key5 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
                  _val6 = iprot.readString();
                  struct.subject.put(_key5, _val6);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.firstSentence = new HashMap<Language,String>(2*_map8.size);
                Language _key9;
                String _val10;
                for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                {
                  _key9 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
                  _val10 = iprot.readString();
                  struct.firstSentence.put(_key9, _val10);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.legals = new HashMap<Language,String>(2*_map12.size);
                Language _key13;
                String _val14;
                for (int _i15 = 0; _i15 < _map12.size; ++_i15)
                {
                  _key13 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
                  _val14 = iprot.readString();
                  struct.legals.put(_key13, _val14);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EmailCampaign struct) throws org.apache.thrift.TException {
      ...
      if (struct.baseUrl != null) {
        oprot.writeFieldBegin(BASE_URL_FIELD_DESC);
        {
          ...
          for (Map.Entry<Language, String> _iter16 : struct.baseUrl.entrySet())
          {
      ...
      if (struct.subject != null) {
        oprot.writeFieldBegin(SUBJECT_FIELD_DESC);
        {
          ...
          for (Map.Entry<Language, String> _iter17 : struct.subject.entrySet())
          {
      ...
      if (struct.firstSentence != null) {
        oprot.writeFieldBegin(FIRST_SENTENCE_FIELD_DESC);
        {
          ...
          for (Map.Entry<Language, String> _iter18 : struct.firstSentence.entrySet())
          {
      ...
      if (struct.legals != null) {
        oprot.writeFieldBegin(LEGALS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Language, String> _iter19 : struct.legals.entrySet())
          {
            oprot.writeI32(_iter19.getKey().getValue());
  ...
  private static class EmailCampaignTupleScheme extends TupleScheme<EmailCampaign> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, EmailCampaign struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.dateTime);
      {
        ...
        for (Map.Entry<Language, String> _iter20 : struct.baseUrl.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<Language, String> _iter21 : struct.subject.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<Language, String> _iter22 : struct.firstSentence.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<Language, String> _iter23 : struct.legals.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, EmailCampaign struct) throws org.apache.thrift.TException {
      ...
      struct.setDateTimeIsSet(true);
      {
        ...
        struct.baseUrl = new HashMap<Language,String>(2*_map24.size);
        Language _key25;
        String _val26;
        for (int _i27 = 0; _i27 < _map24.size; ++_i27)
        {
          ...
          struct.baseUrl.put(_key25, _val26);
        }
      }
      struct.setBaseUrlIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map28 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
        struct.subject = new HashMap<Language,String>(2*_map28.size);
        Language _key29;
        String _val30;
        for (int _i31 = 0; _i31 < _map28.size; ++_i31)
        {
          ...
          struct.subject.put(_key29, _val30);
        }
      }
      struct.setSubjectIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map32 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
        struct.firstSentence = new HashMap<Language,String>(2*_map32.size);
        Language _key33;
        String _val34;
        for (int _i35 = 0; _i35 < _map32.size; ++_i35)
        {
          _key33 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
          _val34 = iprot.readString();
          struct.firstSentence.put(_key33, _val34);
        }
      }
      struct.setFirstSentenceIsSet(true);
      {
        ...
        struct.legals = new HashMap<Language,String>(2*_map36.size);
        Language _key37;
        String _val38;
        for (int _i39 = 0; _i39 < _map36.size; ++_i39)
        {
          _key37 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
          _val38 = iprot.readString();
          struct.legals.put(_key37, _val38);
        }
      }
      struct.setLegalsIsSet(true);
    }
