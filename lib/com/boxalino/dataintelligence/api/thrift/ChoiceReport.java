            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new ArrayList<ChoiceReportResult>(_list200.size);
                ChoiceReportResult _elem201;
                for (int _i202 = 0; _i202 < _list200.size; ++_i202)
                {
                  _elem201 = new ChoiceReportResult();
                  _elem201.read(iprot);
                  struct.results.add(_elem201);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChoiceReport struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (ChoiceReportResult _iter203 : struct.results)
          {
  ...
  private static class ChoiceReportTupleScheme extends TupleScheme<ChoiceReport> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ChoiceReport struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ChoiceReportResult _iter204 : struct.results)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ChoiceReport struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.results = new ArrayList<ChoiceReportResult>(_list205.size);
        ChoiceReportResult _elem206;
        for (int _i207 = 0; _i207 < _list205.size; ++_i207)
        {
          _elem206 = new ChoiceReportResult();
          _elem206.read(iprot);
          struct.results.add(_elem206);
        }
      }
      struct.setResultsIsSet(true);
      struct.sumResult = new ReportResultValues();
