...
public class BehaviorReport implements org.apache.thrift.TBase<BehaviorReport, BehaviorReport._Fields>, java.io.Serializable, Cloneable, Comparable<BehaviorReport> {
   ...
   */
  public Map<BehaviorReportResult,ReportResultValues> results; // required
  /**
   * the sum result
   */
  ...
  public BehaviorReport(
    Map<BehaviorReportResult,ReportResultValues> results,
  ...
  public BehaviorReport(BehaviorReport other) {
    if (other.isSetResults()) {
      Map<BehaviorReportResult,ReportResultValues> __this__results = new HashMap<BehaviorReportResult,ReportResultValues>(other.results.size());
      for (Map.Entry<BehaviorReportResult, ReportResultValues> other_element : other.results.entrySet()) {

        BehaviorReportResult other_element_key = other_element.getKey();
        ReportResultValues other_element_value = other_element.getValue();

        BehaviorReportResult __this__results_copy_key = new BehaviorReportResult(other_element_key);
  ...
  public void putToResults(BehaviorReportResult key, ReportResultValues val) {
    if (this.results == null) {
      this.results = new HashMap<BehaviorReportResult,ReportResultValues>();
    }
   ...
   * the map of reporting results (one result per BehaviorReportResult: indicating dimension values)
   */
  public Map<BehaviorReportResult,ReportResultValues> getResults() {
    return this.results;
  }
   ...
   * the map of reporting results (one result per BehaviorReportResult: indicating dimension values)
   */
  public BehaviorReport setResults(Map<BehaviorReportResult,ReportResultValues> results) {
    this.results = results;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULTS:
      if (value == null) {
        ...
        setResults((Map<BehaviorReportResult,ReportResultValues>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.results = new HashMap<BehaviorReportResult,ReportResultValues>(2*_map296.size);
                BehaviorReportResult _key297;
                ReportResultValues _val298;
                for (int _i299 = 0; _i299 < _map296.size; ++_i299)
                {
                  _key297 = new BehaviorReportResult();
                  _key297.read(iprot);
                  _val298 = new ReportResultValues();
                  _val298.read(iprot);
                  struct.results.put(_key297, _val298);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BehaviorReport struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<BehaviorReportResult, ReportResultValues> _iter300 : struct.results.entrySet())
          {
  ...
  private static class BehaviorReportTupleScheme extends TupleScheme<BehaviorReport> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, BehaviorReport struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<BehaviorReportResult, ReportResultValues> _iter301 : struct.results.entrySet())
        {
          _iter301.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BehaviorReport struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map302 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.results = new HashMap<BehaviorReportResult,ReportResultValues>(2*_map302.size);
        BehaviorReportResult _key303;
        ReportResultValues _val304;
        for (int _i305 = 0; _i305 < _map302.size; ++_i305)
        {
          _key303 = new BehaviorReportResult();
          _key303.read(iprot);
          _val304 = new ReportResultValues();
          _val304.read(iprot);
          struct.results.put(_key303, _val304);
        }
      }
      struct.setResultsIsSet(true);
      struct.sumResult = new ReportResultValues();
