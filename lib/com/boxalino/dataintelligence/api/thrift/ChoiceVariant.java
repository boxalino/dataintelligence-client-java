            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tags = new ArrayList<String>(_list66.size);
                String _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = iprot.readString();
                  struct.tags.add(_elem67);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.simpleParameters = new HashMap<String,List<String>>(2*_map69.size);
                String _key70;
                List<String> _val71;
                for (int _i72 = 0; _i72 < _map69.size; ++_i72)
                {
                  ...
                  struct.simpleParameters.put(_key70, _val71);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.localizedParemeters = new HashMap<String,List<Map<Language,String>>>(2*_map76.size);
                String _key77;
                List<Map<Language,String>> _val78;
                for (int _i79 = 0; _i79 < _map76.size; ++_i79)
                {
                  _key77 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TList _list80 = iprot.readListBegin();
                    _val78 = new ArrayList<Map<Language,String>>(_list80.size);
                    Map<Language,String> _elem81;
                    for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                    {
                      {
                        org.apache.thrift.protocol.TMap _map83 = iprot.readMapBegin();
                        _elem81 = new HashMap<Language,String>(2*_map83.size);
                        Language _key84;
                        String _val85;
                        for (int _i86 = 0; _i86 < _map83.size; ++_i86)
                        {
                          _key84 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
                          _val85 = iprot.readString();
                          _elem81.put(_key84, _val85);
                        }
                        iprot.readMapEnd();
                      }
                      _val78.add(_elem81);
                  ...
                  struct.localizedParemeters.put(_key77, _val78);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChoiceVariant struct) throws org.apache.thrift.TException {
      ...
      if (struct.tags != null) {
        oprot.writeFieldBegin(TAGS_FIELD_DESC);
        {
          ...
          for (String _iter87 : struct.tags)
          {
      ...
      if (struct.simpleParameters != null) {
        oprot.writeFieldBegin(SIMPLE_PARAMETERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<String>> _iter88 : struct.simpleParameters.entrySet())
          {
            oprot.writeString(_iter88.getKey());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, _iter88.getValue().size()));
      ...
      if (struct.localizedParemeters != null) {
        oprot.writeFieldBegin(LOCALIZED_PAREMETERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<Map<Language,String>>> _iter90 : struct.localizedParemeters.entrySet())
          {
            oprot.writeString(_iter90.getKey());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.MAP, _iter90.getValue().size()));
              for (Map<Language,String> _iter91 : _iter90.getValue())
              {
                {
                  oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, _iter91.size()));
                  for (Map.Entry<Language, String> _iter92 : _iter91.entrySet())
                  {
  ...
  private static class ChoiceVariantTupleScheme extends TupleScheme<ChoiceVariant> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ChoiceVariant struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.choiceId);
      {
        ...
        for (String _iter93 : struct.tags)
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, List<String>> _iter94 : struct.simpleParameters.entrySet())
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, List<Map<Language,String>>> _iter96 : struct.localizedParemeters.entrySet())
        {
          oprot.writeString(_iter96.getKey());
          {
            oprot.writeI32(_iter96.getValue().size());
            for (Map<Language,String> _iter97 : _iter96.getValue())
            {
              {
                oprot.writeI32(_iter97.size());
                for (Map.Entry<Language, String> _iter98 : _iter97.entrySet())
                {
                  oprot.writeI32(_iter98.getKey().getValue());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ChoiceVariant struct) throws org.apache.thrift.TException {
      ...
      struct.setChoiceIdIsSet(true);
      {
        ...
        struct.tags = new ArrayList<String>(_list99.size);
        String _elem100;
        for (int _i101 = 0; _i101 < _list99.size; ++_i101)
        {
          _elem100 = iprot.readString();
          struct.tags.add(_elem100);
        }
      }
      struct.setTagsIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map102 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.simpleParameters = new HashMap<String,List<String>>(2*_map102.size);
        String _key103;
        List<String> _val104;
        for (int _i105 = 0; _i105 < _map102.size; ++_i105)
        {
          ...
          struct.simpleParameters.put(_key103, _val104);
        }
      }
      struct.setSimpleParametersIsSet(true);
      {
        ...
        struct.localizedParemeters = new HashMap<String,List<Map<Language,String>>>(2*_map109.size);
        String _key110;
        List<Map<Language,String>> _val111;
        for (int _i112 = 0; _i112 < _map109.size; ++_i112)
        {
          _key110 = iprot.readString();
          {
            ...
            _val111 = new ArrayList<Map<Language,String>>(_list113.size);
            Map<Language,String> _elem114;
            for (int _i115 = 0; _i115 < _list113.size; ++_i115)
            {
              {
                org.apache.thrift.protocol.TMap _map116 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
                _elem114 = new HashMap<Language,String>(2*_map116.size);
                Language _key117;
                String _val118;
                for (int _i119 = 0; _i119 < _map116.size; ++_i119)
                {
                  _key117 = com.boxalino.dataintelligence.api.thrift.Language.findByValue(iprot.readI32());
          ...
          struct.localizedParemeters.put(_key110, _val111);
        }
      }
      struct.setLocalizedParemetersIsSet(true);
    }
