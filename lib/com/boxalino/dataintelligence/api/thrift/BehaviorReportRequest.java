            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new ArrayList<ReportMetric>(_list226.size);
                ReportMetric _elem227;
                for (int _i228 = 0; _i228 < _list226.size; ++_i228)
                {
                  _elem227 = new ReportMetric();
                  _elem227.read(iprot);
                  struct.metrics.add(_elem227);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dimensions = new ArrayList<ReportDimension>(_list229.size);
                ReportDimension _elem230;
                for (int _i231 = 0; _i231 < _list229.size; ++_i231)
                {
                  _elem230 = new ReportDimension();
                  _elem230.read(iprot);
                  struct.dimensions.add(_elem230);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sortBys = new ArrayList<ReportMetric>(_list232.size);
                ReportMetric _elem233;
                for (int _i234 = 0; _i234 < _list232.size; ++_i234)
                {
                  _elem233 = new ReportMetric();
                  _elem233.read(iprot);
                  struct.sortBys.add(_elem233);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BehaviorReportRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (ReportMetric _iter235 : struct.metrics)
          {
      ...
      if (struct.dimensions != null) {
        if (struct.isSetDimensions()) {
          oprot.writeFieldBegin(DIMENSIONS_FIELD_DESC);
          {
            ...
            for (ReportDimension _iter236 : struct.dimensions)
            {
      ...
      if (struct.sortBys != null) {
        if (struct.isSetSortBys()) {
          oprot.writeFieldBegin(SORT_BYS_FIELD_DESC);
          {
            ...
            for (ReportMetric _iter237 : struct.sortBys)
            {
  ...
  private static class BehaviorReportRequestTupleScheme extends TupleScheme<BehaviorReportRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, BehaviorReportRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ReportMetric _iter238 : struct.metrics)
        {
      ...
      if (struct.isSetDimensions()) {
        {
          ...
          for (ReportDimension _iter239 : struct.dimensions)
          {
      ...
      if (struct.isSetSortBys()) {
        {
          ...
          for (ReportMetric _iter240 : struct.sortBys)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BehaviorReportRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.metrics = new ArrayList<ReportMetric>(_list241.size);
        ReportMetric _elem242;
        for (int _i243 = 0; _i243 < _list241.size; ++_i243)
        {
          _elem242 = new ReportMetric();
          _elem242.read(iprot);
          struct.metrics.add(_elem242);
        }
      }
      struct.setMetricsIsSet(true);
      struct.range = new TimeRange();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.dimensions = new ArrayList<ReportDimension>(_list244.size);
          ReportDimension _elem245;
          for (int _i246 = 0; _i246 < _list244.size; ++_i246)
          {
            _elem245 = new ReportDimension();
            _elem245.read(iprot);
            struct.dimensions.add(_elem245);
          }
        }
        struct.setDimensionsIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.sortBys = new ArrayList<ReportMetric>(_list247.size);
          ReportMetric _elem248;
          for (int _i249 = 0; _i249 < _list247.size; ++_i249)
          {
            _elem248 = new ReportMetric();
            _elem248.read(iprot);
            struct.sortBys.add(_elem248);
          }
        }
        struct.setSortBysIsSet(true);
      }
