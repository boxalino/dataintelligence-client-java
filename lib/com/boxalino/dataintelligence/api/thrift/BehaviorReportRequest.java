            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new ArrayList<ReportMetric>(_list248.size);
                ReportMetric _elem249;
                for (int _i250 = 0; _i250 < _list248.size; ++_i250)
                {
                  _elem249 = new ReportMetric();
                  _elem249.read(iprot);
                  struct.metrics.add(_elem249);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dimensions = new ArrayList<ReportDimension>(_list251.size);
                ReportDimension _elem252;
                for (int _i253 = 0; _i253 < _list251.size; ++_i253)
                {
                  _elem252 = new ReportDimension();
                  _elem252.read(iprot);
                  struct.dimensions.add(_elem252);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sortBys = new ArrayList<ReportMetric>(_list254.size);
                ReportMetric _elem255;
                for (int _i256 = 0; _i256 < _list254.size; ++_i256)
                {
                  _elem255 = new ReportMetric();
                  _elem255.read(iprot);
                  struct.sortBys.add(_elem255);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BehaviorReportRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (ReportMetric _iter257 : struct.metrics)
          {
      ...
      if (struct.dimensions != null) {
        if (struct.isSetDimensions()) {
          oprot.writeFieldBegin(DIMENSIONS_FIELD_DESC);
          {
            ...
            for (ReportDimension _iter258 : struct.dimensions)
            {
      ...
      if (struct.sortBys != null) {
        if (struct.isSetSortBys()) {
          oprot.writeFieldBegin(SORT_BYS_FIELD_DESC);
          {
            ...
            for (ReportMetric _iter259 : struct.sortBys)
            {
  ...
  private static class BehaviorReportRequestTupleScheme extends TupleScheme<BehaviorReportRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, BehaviorReportRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ReportMetric _iter260 : struct.metrics)
        {
      ...
      if (struct.isSetDimensions()) {
        {
          ...
          for (ReportDimension _iter261 : struct.dimensions)
          {
      ...
      if (struct.isSetSortBys()) {
        {
          ...
          for (ReportMetric _iter262 : struct.sortBys)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BehaviorReportRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.metrics = new ArrayList<ReportMetric>(_list263.size);
        ReportMetric _elem264;
        for (int _i265 = 0; _i265 < _list263.size; ++_i265)
        {
          _elem264 = new ReportMetric();
          _elem264.read(iprot);
          struct.metrics.add(_elem264);
        }
      }
      struct.setMetricsIsSet(true);
      struct.range = new TimeRange();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.dimensions = new ArrayList<ReportDimension>(_list266.size);
          ReportDimension _elem267;
          for (int _i268 = 0; _i268 < _list266.size; ++_i268)
          {
            _elem267 = new ReportDimension();
            _elem267.read(iprot);
            struct.dimensions.add(_elem267);
          }
        }
        struct.setDimensionsIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.sortBys = new ArrayList<ReportMetric>(_list269.size);
          ReportMetric _elem270;
          for (int _i271 = 0; _i271 < _list269.size; ++_i271)
          {
            _elem270 = new ReportMetric();
            _elem270.read(iprot);
            struct.sortBys.add(_elem270);
          }
        }
        struct.setSortBysIsSet(true);
      }
