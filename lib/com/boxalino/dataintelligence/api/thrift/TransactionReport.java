...
public class TransactionReport implements org.apache.thrift.TBase<TransactionReport, TransactionReport._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionReport> {
   ...
   */
  public Map<TransactionReportResult,ReportResultValues> results; // required
  /**
   * the sum result
   */
  ...
  public TransactionReport(
    Map<TransactionReportResult,ReportResultValues> results,
  ...
  public TransactionReport(TransactionReport other) {
    if (other.isSetResults()) {
      Map<TransactionReportResult,ReportResultValues> __this__results = new HashMap<TransactionReportResult,ReportResultValues>(other.results.size());
      for (Map.Entry<TransactionReportResult, ReportResultValues> other_element : other.results.entrySet()) {

        TransactionReportResult other_element_key = other_element.getKey();
        ReportResultValues other_element_value = other_element.getValue();

        TransactionReportResult __this__results_copy_key = new TransactionReportResult(other_element_key);
  ...
  public void putToResults(TransactionReportResult key, ReportResultValues val) {
    if (this.results == null) {
      this.results = new HashMap<TransactionReportResult,ReportResultValues>();
    }
   ...
   * the map of reporting results (one result per TransactionReportResult: indicating dimension values)
   */
  public Map<TransactionReportResult,ReportResultValues> getResults() {
    return this.results;
  }
   ...
   * the map of reporting results (one result per TransactionReportResult: indicating dimension values)
   */
  public TransactionReport setResults(Map<TransactionReportResult,ReportResultValues> results) {
    this.results = results;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULTS:
      if (value == null) {
        ...
        setResults((Map<TransactionReportResult,ReportResultValues>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.results = new HashMap<TransactionReportResult,ReportResultValues>(2*_map252.size);
                TransactionReportResult _key253;
                ReportResultValues _val254;
                for (int _i255 = 0; _i255 < _map252.size; ++_i255)
                {
                  _key253 = new TransactionReportResult();
                  _key253.read(iprot);
                  _val254 = new ReportResultValues();
                  _val254.read(iprot);
                  struct.results.put(_key253, _val254);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionReport struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<TransactionReportResult, ReportResultValues> _iter256 : struct.results.entrySet())
          {
            _iter256.getKey().write(oprot);
  ...
  private static class TransactionReportTupleScheme extends TupleScheme<TransactionReport> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TransactionReport struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<TransactionReportResult, ReportResultValues> _iter257 : struct.results.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TransactionReport struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map258 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.results = new HashMap<TransactionReportResult,ReportResultValues>(2*_map258.size);
        TransactionReportResult _key259;
        ReportResultValues _val260;
        for (int _i261 = 0; _i261 < _map258.size; ++_i261)
        {
          _key259 = new TransactionReportResult();
          _key259.read(iprot);
          _val260 = new ReportResultValues();
          _val260.read(iprot);
          struct.results.put(_key259, _val260);
        }
      }
      struct.setResultsIsSet(true);
      struct.sumResult = new ReportResultValues();
