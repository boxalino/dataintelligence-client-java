...
public class ChoiceReportRequest implements org.apache.thrift.TBase<ChoiceReportRequest, ChoiceReportRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ChoiceReportRequest> {
  ...
  private static final org.apache.thrift.protocol.TField CHOICE_VARIANTS_FIELD_DESC = new org.apache.thrift.protocol.TField("choiceVariants", org.apache.thrift.protocol.TType.LIST, (short)3);
  private static final org.apache.thrift.protocol.TField RETURN_RECOMMENDATION_STRATEGIES_FIELD_DESC = new org.apache.thrift.protocol.TField("returnRecommendationStrategies", org.apache.thrift.protocol.TType.BOOL, (short)4);
  private static final org.apache.thrift.protocol.TField DIMENSION_FIELD_DESC = new org.apache.thrift.protocol.TField("dimension", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  private static final org.apache.thrift.protocol.TField FUNNEL_METRICS_FIELD_DESC = new org.apache.thrift.protocol.TField("funnelMetrics", org.apache.thrift.protocol.TType.LIST, (short)6);
  private static final org.apache.thrift.protocol.TField SORT_BYS_FIELD_DESC = new org.apache.thrift.protocol.TField("sortBys", org.apache.thrift.protocol.TType.LIST, (short)7);
  ...
  private static final org.apache.thrift.protocol.TField START_INDEX_FIELD_DESC = new org.apache.thrift.protocol.TField("startIndex", org.apache.thrift.protocol.TType.I16, (short)10);
  private static final org.apache.thrift.protocol.TField MAX_RESULTS_FIELD_DESC = new org.apache.thrift.protocol.TField("maxResults", org.apache.thrift.protocol.TType.I16, (short)11);
   ...
   */
  public List<ChoiceVariant> choiceVariants; // optional
  /**
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * an optional choice variants to use as filters (only return the results for these choicevariants)
     */
    CHOICE_VARIANTS((short)3, "choiceVariants"),
    /**
     * an optional flag to indicate that the results should display not only the choice variant, but which recommendation strategies have been used for each choice variant (only applicable if the choice is a recommendation choice)
     */
    RETURN_RECOMMENDATION_STRATEGIES((short)4, "returnRecommendationStrategies"),
    /**
     * an optional dimension for the report (for segmentation), while groups are different for each type of reporting, the dimension are normally standard (visitor country, device, ...)
     */
    DIMENSION((short)5, "dimension"),
    /**
     * an optional list of metrics to limit the report to only the cases where at least one of the metrics of the list was reached (e.g.: if focusedMetrics are goal-X and goal-Y, then the Metric Transactions will not be returned for all the visits, but only for the visits who did reach goal-X or goal-Y at least once)
     */
    FUNNEL_METRICS((short)6, "funnelMetrics"),
    /**
     * the metrics to use for sorting the results
     */
    SORT_BYS((short)7, "sortBys"),
    /**
     * a required date range for the reporting response (precision is only managed per day)
     */
    RANGE((short)8, "range"),
     ...
     * an optional starting index (e.g.: if the maximum number of results was exceeded and a second page needs to be displayed). First index is 0.
     */
    START_INDEX((short)10, "startIndex"),
    /**
     * an required number of maximum number of results (one result is one source of date rage data in of values for all kpis)
     */
    MAX_RESULTS((short)11, "maxResults");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // METRICS
          return METRICS;
        case 3: // CHOICE_VARIANTS
          return CHOICE_VARIANTS;
        case 4: // RETURN_RECOMMENDATION_STRATEGIES
          return RETURN_RECOMMENDATION_STRATEGIES;
        case 5: // DIMENSION
          return DIMENSION;
        case 6: // FUNNEL_METRICS
  ...
  private static final _Fields optionals[] = {_Fields.CHOICE_VARIANTS,_Fields.RETURN_RECOMMENDATION_STRATEGIES,_Fields.DIMENSION,_Fields.FUNNEL_METRICS,_Fields.SORT_BYS,_Fields.START_INDEX};
  ...
  static {
    ...
    tmpMap.put(_Fields.CHOICE_VARIANTS, new org.apache.thrift.meta_data.FieldMetaData("choiceVariants", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
  ...
  public ChoiceReportRequest(ChoiceReportRequest other) {
    ...
    if (other.isSetChoiceVariants()) {
      List<ChoiceVariant> __this__choiceVariants = new ArrayList<ChoiceVariant>(other.choiceVariants.size());
      for (ChoiceVariant other_element : other.choiceVariants) {
        __this__choiceVariants.add(new ChoiceVariant(other_element));
      }
      this.choiceVariants = __this__choiceVariants;
    }
  ...
  public int getChoiceVariantsSize() {
    return (this.choiceVariants == null) ? 0 : this.choiceVariants.size();
  }

  public java.util.Iterator<ChoiceVariant> getChoiceVariantsIterator() {
    return (this.choiceVariants == null) ? null : this.choiceVariants.iterator();
  }

  public void addToChoiceVariants(ChoiceVariant elem) {
    if (this.choiceVariants == null) {
      this.choiceVariants = new ArrayList<ChoiceVariant>();
    }
    this.choiceVariants.add(elem);
  }

  /**
   * an optional choice variants to use as filters (only return the results for these choicevariants)
   */
  public List<ChoiceVariant> getChoiceVariants() {
    return this.choiceVariants;
  }

  /**
   * an optional choice variants to use as filters (only return the results for these choicevariants)
   */
  public ChoiceReportRequest setChoiceVariants(List<ChoiceVariant> choiceVariants) {
    this.choiceVariants = choiceVariants;
    return this;
  }

  public void unsetChoiceVariants() {
    this.choiceVariants = null;
  }

  /** Returns true if field choiceVariants is set (has been assigned a value) and false otherwise */
  public boolean isSetChoiceVariants() {
    return this.choiceVariants != null;
  }

  public void setChoiceVariantsIsSet(boolean value) {
    if (!value) {
      this.choiceVariants = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CHOICE_VARIANTS:
      if (value == null) {
        unsetChoiceVariants();
      } else {
        setChoiceVariants((List<ChoiceVariant>)value);
      }
      break;
  ...
  public boolean equals(ChoiceReportRequest that) {
    ...
    boolean this_present_choiceVariants = true && this.isSetChoiceVariants();
    boolean that_present_choiceVariants = true && that.isSetChoiceVariants();
    if (this_present_choiceVariants || that_present_choiceVariants) {
      if (!(this_present_choiceVariants && that_present_choiceVariants))
        return false;
      if (!this.choiceVariants.equals(that.choiceVariants))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_choiceVariants = true && (isSetChoiceVariants());
    list.add(present_choiceVariants);
    if (present_choiceVariants)
      list.add(choiceVariants);
  ...
  public int compareTo(ChoiceReportRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetChoiceVariants()).compareTo(other.isSetChoiceVariants());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChoiceVariants()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.choiceVariants, other.choiceVariants);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetChoiceVariants()) {
      if (!first) sb.append(", ");
      sb.append("choiceVariants:");
      if (this.choiceVariants == null) {
        sb.append("null");
      } else {
        sb.append(this.choiceVariants);
      }
      first = false;
    }
    if (isSetReturnRecommendationStrategies()) {
  ...
  private static class ChoiceReportRequestStandardScheme extends StandardScheme<ChoiceReportRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new ArrayList<ReportMetric>(_list156.size);
                ReportMetric _elem157;
                for (int _i158 = 0; _i158 < _list156.size; ++_i158)
                {
                  _elem157 = new ReportMetric();
                  _elem157.read(iprot);
                  struct.metrics.add(_elem157);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.choiceVariants = new ArrayList<ChoiceVariant>(_list159.size);
                ChoiceVariant _elem160;
                for (int _i161 = 0; _i161 < _list159.size; ++_i161)
                {
                  _elem160 = new ChoiceVariant();
                  _elem160.read(iprot);
                  struct.choiceVariants.add(_elem160);
                }
                iprot.readListEnd();
              }
              struct.setChoiceVariantsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.funnelMetrics = new ArrayList<ReportMetric>(_list162.size);
                ReportMetric _elem163;
                for (int _i164 = 0; _i164 < _list162.size; ++_i164)
                {
                  _elem163 = new ReportMetric();
                  _elem163.read(iprot);
                  struct.funnelMetrics.add(_elem163);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sortBys = new ArrayList<ReportMetric>(_list165.size);
                ReportMetric _elem166;
                for (int _i167 = 0; _i167 < _list165.size; ++_i167)
                {
                  _elem166 = new ReportMetric();
                  _elem166.read(iprot);
                  struct.sortBys.add(_elem166);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChoiceReportRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.choiceVariants != null) {
        if (struct.isSetChoiceVariants()) {
          oprot.writeFieldBegin(CHOICE_VARIANTS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.choiceVariants.size()));
            for (ChoiceVariant _iter169 : struct.choiceVariants)
            {
  ...
  private static class ChoiceReportRequestTupleScheme extends TupleScheme<ChoiceReportRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ChoiceReportRequest struct) throws org.apache.thrift.TException {
      ...
      struct.choice.write(oprot);
      {
        ...
        for (ReportMetric _iter172 : struct.metrics)
        {
      ...
      if (struct.isSetChoiceVariants()) {
        {
          oprot.writeI32(struct.choiceVariants.size());
          for (ChoiceVariant _iter173 : struct.choiceVariants)
          {
      ...
      if (struct.isSetFunnelMetrics()) {
        {
          ...
          for (ReportMetric _iter174 : struct.funnelMetrics)
          {
      ...
      if (struct.isSetSortBys()) {
        {
          ...
          for (ReportMetric _iter175 : struct.sortBys)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ChoiceReportRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setChoiceIsSet(true);
      {
        ...
        struct.metrics = new ArrayList<ReportMetric>(_list176.size);
        ReportMetric _elem177;
        for (int _i178 = 0; _i178 < _list176.size; ++_i178)
        {
          _elem177 = new ReportMetric();
          _elem177.read(iprot);
          struct.metrics.add(_elem177);
        }
      }
      struct.setMetricsIsSet(true);
      struct.range = new TimeRange();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.choiceVariants = new ArrayList<ChoiceVariant>(_list179.size);
          ChoiceVariant _elem180;
          for (int _i181 = 0; _i181 < _list179.size; ++_i181)
          {
            _elem180 = new ChoiceVariant();
            _elem180.read(iprot);
            struct.choiceVariants.add(_elem180);
          }
        }
        struct.setChoiceVariantsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.funnelMetrics = new ArrayList<ReportMetric>(_list182.size);
          ReportMetric _elem183;
          for (int _i184 = 0; _i184 < _list182.size; ++_i184)
          {
            _elem183 = new ReportMetric();
            _elem183.read(iprot);
            struct.funnelMetrics.add(_elem183);
          }
        }
        struct.setFunnelMetricsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.sortBys = new ArrayList<ReportMetric>(_list185.size);
          ReportMetric _elem186;
          for (int _i187 = 0; _i187 < _list185.size; ++_i187)
          {
            _elem186 = new ReportMetric();
            _elem186.read(iprot);
            struct.sortBys.add(_elem186);
          }
        }
        struct.setSortBysIsSet(true);
      }
