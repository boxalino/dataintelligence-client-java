            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.choiceVariantIds = new ArrayList<String>(_list165.size);
                String _elem166;
                for (int _i167 = 0; _i167 < _list165.size; ++_i167)
                {
                  _elem166 = iprot.readString();
                  struct.choiceVariantIds.add(_elem166);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.funnelMetrics = new ArrayList<ReportMetric>(_list168.size);
                ReportMetric _elem169;
                for (int _i170 = 0; _i170 < _list168.size; ++_i170)
                {
                  _elem169 = new ReportMetric();
                  _elem169.read(iprot);
                  struct.funnelMetrics.add(_elem169);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sortBys = new ArrayList<ReportMetric>(_list171.size);
                ReportMetric _elem172;
                for (int _i173 = 0; _i173 < _list171.size; ++_i173)
                {
                  _elem172 = new ReportMetric();
                  _elem172.read(iprot);
                  struct.sortBys.add(_elem172);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChoiceReportRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (ReportMetric _iter174 : struct.metrics)
          {
      ...
      if (struct.choiceVariantIds != null) {
        if (struct.isSetChoiceVariantIds()) {
          oprot.writeFieldBegin(CHOICE_VARIANT_IDS_FIELD_DESC);
          {
            ...
            for (String _iter175 : struct.choiceVariantIds)
            {
      ...
      if (struct.funnelMetrics != null) {
        if (struct.isSetFunnelMetrics()) {
          oprot.writeFieldBegin(FUNNEL_METRICS_FIELD_DESC);
          {
            ...
            for (ReportMetric _iter176 : struct.funnelMetrics)
            {
      ...
      if (struct.sortBys != null) {
        if (struct.isSetSortBys()) {
          oprot.writeFieldBegin(SORT_BYS_FIELD_DESC);
          {
            ...
            for (ReportMetric _iter177 : struct.sortBys)
            {
  ...
  private static class ChoiceReportRequestTupleScheme extends TupleScheme<ChoiceReportRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ChoiceReportRequest struct) throws org.apache.thrift.TException {
      ...
      struct.choice.write(oprot);
      {
        ...
        for (ReportMetric _iter178 : struct.metrics)
        {
      ...
      if (struct.isSetChoiceVariantIds()) {
        {
          ...
          for (String _iter179 : struct.choiceVariantIds)
          {
      ...
      if (struct.isSetFunnelMetrics()) {
        {
          ...
          for (ReportMetric _iter180 : struct.funnelMetrics)
          {
      ...
      if (struct.isSetSortBys()) {
        {
          ...
          for (ReportMetric _iter181 : struct.sortBys)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.choiceVariantIds = new ArrayList<String>(_list185.size);
          String _elem186;
          for (int _i187 = 0; _i187 < _list185.size; ++_i187)
          {
            _elem186 = iprot.readString();
            struct.choiceVariantIds.add(_elem186);
          }
        }
        struct.setChoiceVariantIdsIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.funnelMetrics = new ArrayList<ReportMetric>(_list188.size);
          ReportMetric _elem189;
          for (int _i190 = 0; _i190 < _list188.size; ++_i190)
          {
            _elem189 = new ReportMetric();
            _elem189.read(iprot);
            struct.funnelMetrics.add(_elem189);
          }
        }
        struct.setFunnelMetricsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.sortBys = new ArrayList<ReportMetric>(_list191.size);
          ReportMetric _elem192;
          for (int _i193 = 0; _i193 < _list191.size; ++_i193)
          {
            _elem192 = new ReportMetric();
            _elem192.read(iprot);
            struct.sortBys.add(_elem192);
          }
        }
        struct.setSortBysIsSet(true);
      }
