...
public class TransactionReportRequest implements org.apache.thrift.TBase<TransactionReportRequest, TransactionReportRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionReportRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.DIMENSIONS,_Fields.FILTER,_Fields.COHORT_ID_FIELD,_Fields.SORT_BYS,_Fields.START_INDEX};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new ArrayList<ReportMetric>(_list208.size);
                ReportMetric _elem209;
                for (int _i210 = 0; _i210 < _list208.size; ++_i210)
                {
                  _elem209 = new ReportMetric();
                  _elem209.read(iprot);
                  struct.metrics.add(_elem209);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dimensions = new ArrayList<ReportDimension>(_list211.size);
                ReportDimension _elem212;
                for (int _i213 = 0; _i213 < _list211.size; ++_i213)
                {
                  _elem212 = new ReportDimension();
                  _elem212.read(iprot);
                  struct.dimensions.add(_elem212);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sortBys = new ArrayList<ReportMetric>(_list214.size);
                ReportMetric _elem215;
                for (int _i216 = 0; _i216 < _list214.size; ++_i216)
                {
                  _elem215 = new ReportMetric();
                  _elem215.read(iprot);
                  struct.sortBys.add(_elem215);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionReportRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (ReportMetric _iter217 : struct.metrics)
          {
      ...
      if (struct.dimensions != null) {
        if (struct.isSetDimensions()) {
          oprot.writeFieldBegin(DIMENSIONS_FIELD_DESC);
          {
            ...
            for (ReportDimension _iter218 : struct.dimensions)
            {
      ...
      if (struct.sortBys != null) {
        if (struct.isSetSortBys()) {
          oprot.writeFieldBegin(SORT_BYS_FIELD_DESC);
          {
            ...
            for (ReportMetric _iter219 : struct.sortBys)
            {
  ...
  private static class TransactionReportRequestTupleScheme extends TupleScheme<TransactionReportRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TransactionReportRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ReportMetric _iter220 : struct.metrics)
        {
      ...
      if (struct.isSetDimensions()) {
        {
          ...
          for (ReportDimension _iter221 : struct.dimensions)
          {
      ...
      if (struct.isSetSortBys()) {
        {
          ...
          for (ReportMetric _iter222 : struct.sortBys)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TransactionReportRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.metrics = new ArrayList<ReportMetric>(_list223.size);
        ReportMetric _elem224;
        for (int _i225 = 0; _i225 < _list223.size; ++_i225)
        {
          _elem224 = new ReportMetric();
          _elem224.read(iprot);
          struct.metrics.add(_elem224);
        }
      }
      struct.setMetricsIsSet(true);
      struct.range = new TimeRange();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.dimensions = new ArrayList<ReportDimension>(_list226.size);
          ReportDimension _elem227;
          for (int _i228 = 0; _i228 < _list226.size; ++_i228)
          {
            _elem227 = new ReportDimension();
            _elem227.read(iprot);
            struct.dimensions.add(_elem227);
          }
        }
        struct.setDimensionsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.sortBys = new ArrayList<ReportMetric>(_list229.size);
          ReportMetric _elem230;
          for (int _i231 = 0; _i231 < _list229.size; ++_i231)
          {
            _elem230 = new ReportMetric();
            _elem230.read(iprot);
            struct.sortBys.add(_elem230);
          }
        }
        struct.setSortBysIsSet(true);
      }
